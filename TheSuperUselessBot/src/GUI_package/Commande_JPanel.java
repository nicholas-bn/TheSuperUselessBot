...
public class Commande_JPanel extends JPanel {
	...
	public void addListeners() {
		...
		DocumentListener documentListenerNom = new DocumentListener() {
			...
			private void textChanged(DocumentEvent e) {
				commande.setNomCommande(nomCommande.getText().trim());
				System.out.println(Commande_JPanel.this.getCommande().toString());
				anchor.updateListCommand();
			}
		...
		supprimer.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				System.out.println(
						"Suppresion d'un objet \"Commande_JPanel\": " + Commande_JPanel.this.commande.toString());
	...
	// final int prime = 31;
	// int result = 1;
	// result = prime * result + ((activated == null) ? 0 :
	// activated.hashCode());
	...
	// result = prime * result + ((nomCommande == null) ? 0 :
	// nomCommande.hashCode());
	// result = prime * result + ((resultatCommande == null) ? 0 :
	// resultatCommande.hashCode());
	// result = prime * result + ((supprimer == null) ? 0 :
	// supprimer.hashCode());
	// return result;
	// }
	//
